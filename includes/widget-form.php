...
<!-- Title -->
<p>
	<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Widget Title', 'yelp-widget-pro' ); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
</p>

<!-- Listing Options -->
<p class="widget-api-option">
	<label for="<?php echo $this->get_field_id( 'display_option' ); ?>"><?php _e( 'Yelp API Request Method:', 'yelp-widget-pro' ); ?></label><br />
...
<div class="toggle-api-option-1 toggle-item 
<?php
if ( $displayOption == '0' ) {
	echo 'toggled';
}
...
">
	...
	<!-- Limit -->
	<p>
		<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Number of Items:', 'yelp-widget-pro' ); ?></label>
	...
	<!-- Sort -->
	<p>
		<label for="<?php echo $this->get_field_id( 'sort' ); ?>"><?php _e( 'Sorting:', 'yelp-widget-pro' ); ?></label>

		<select name="<?php echo $this->get_field_name( 'sort' ); ?>" id="<?php echo $this->get_field_id( 'sort' ); ?>" class="widefat">
			<?php
			$options = array( __( 'Best Match', 'yelp-widget-pro' ), __( 'Distance', 'yelp-widget-pro' ), __( 'Highest Rated', 'yelp-widget-pro' ) );
...
<div class="toggle-api-option-2 toggle-item  
<?php
if ( $displayOption == '1' ) {
	echo 'toggled';
}
...
<div class="display-options toggle-item">
	...
	<p>
		<input id="<?php echo $this->get_field_id( 'display_address' ); ?>" name="<?php echo $this->get_field_name( 'display_address' ); ?>" type="checkbox"
			   value="1" <?php checked( '1', $address ); ?>/>
		<label for="<?php echo $this->get_field_id( 'display_address' ); ?>"><?php _e( 'Display Business Address', 'yelp-widget-pro' ); ?></label>
	</p>
	<!-- Display address -->

	<p>
		<input id="<?php echo $this->get_field_id( 'display_phone' ); ?>" name="<?php echo $this->get_field_name( 'display_phone' ); ?>" type="checkbox"
			   value="1" <?php checked( '1', $phone ); ?>/>
		<label for="<?php echo $this->get_field_id( 'display_phone' ); ?>"><?php _e( 'Display Business Phone Number', 'yelp-widget-pro' ); ?></label>
	</p>
	<!-- Display phone -->
